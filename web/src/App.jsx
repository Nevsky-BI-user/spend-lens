  ...
  return (
    <div className="app">
      ...
      <footer className="app-footer">
        ...
        {/* Методологія: на підписці рахунок фіксований, тож ці суми — вартість
            виконаної роботи за тарифами API, а не гроші до сплати. Без цього
            рядка «$10 000» читається як борг, і всі висновки зміщуються. */}
        <br />
        Суми пораховано за тарифами Claude API. Якщо ви працюєте за підпискою
        (Pro/Max), це оцінка вартості роботи, а не рахунок до сплати —
        порівнюйте періоди й сесії між собою, а не з сумою в банку.
      </footer>
    </div>
  );
}
