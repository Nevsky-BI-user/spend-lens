...
// v1.8 §3: проєкт, дешевший за цей поріг у видимому зрізі, окремим рядком не
// показується — такі згортаються в «Інші — N проєктів» із розгортанням.
export const SMALL_PROJECT_USD = 50;
