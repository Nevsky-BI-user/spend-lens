...
| Вікно консолі блимає саме собою | Якесь завдання Планувальника має принципал із десктопом і консольний хост | Подвійний клік на `scripts\tasks.vbs` — аудит назве всі такі завдання, ті, що повторюються частіше ніж раз на годину, і те, що реально спрацьовувало останні години. Полагодити — `tasks.vbs fix`: завдання spend-lens і будь-яке `claude-*` переходять на принципал без десктопу (розділ 2) |
