...
SESSION-LESSONS.md         уроки з сесій 25.08–02.09: найчастіші помилки і куди їх дописано
scripts/session_error_stats.py  лічильник помилок у транскриптах сесій (stdlib)
```
